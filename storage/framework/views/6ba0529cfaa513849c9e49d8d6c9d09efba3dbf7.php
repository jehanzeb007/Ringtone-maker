...
<head>
    ...
    <meta charset="utf-8">
    <link href="<?php echo e(asset('css/theme/jquery-ui.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('css/flat.audio.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/jquery.jplayer.min.js')); ?>"></script>
    <style>
    ...
    <script type="text/javascript">
        $(function() {
            $("#jquery_jplayer_audio_1").jPlayer({
                ready: function(event) {
                    $(this).jPlayer("setMedia", {
                        title: " - ",
                        mp3: "<?php echo e($fullFileUrl); ?>?t=<?php echo e(time()); ?>",
                    });
                },
                play: function() {
            ...
            /*<?php echo e(url('')); ?>/download/<?php echo e(base64_encode($fullFilePath)); ?>*/
            $("#download-button").button({ "icons" : { "primary" : "ui-icon-check" } }).click(function(e) {
                downloadURI("<?php echo e($fullFileUrl); ?>?t=<?php echo e(time()); ?>",'ringtone.<?php echo e($lastConvertFileType); ?>');
                this.blur();
